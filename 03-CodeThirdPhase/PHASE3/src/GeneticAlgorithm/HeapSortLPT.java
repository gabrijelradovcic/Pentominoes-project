 ...
 * 
 */
public class HeapSortLPT {

    /**
     * Sorting algorithm, pick a list of individuals
     * and orders by the fitness value
     * @param i list of individuals
     */
    public static void sort(IndividualLPT i[]) {
        int N = i.length;
    ...
    /**
     * Methos needed for the sorting algorithm
     * takes two individuals and puts first the 
     * individual with more fitness value
     * @param i individuals
     * @param k
     * @param N
     */
    private static void downheap(IndividualLPT i[], int k, int N) {
        IndividualLPT T = i[k - 1];
